...
public class ColumnPersonalListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static ColumnPersonalListFragment newInstance(String cid) {
        Bundle args = new Bundle();
        args.putString("cid", cid);
        ColumnPersonalListFragment fragment = new ColumnPersonalListFragment();
...
//        mAdapter.openLoadAnimation(BaseQuickAdapter.SCALEIN);
    ...
    protected void lazyLoad() {
        if (!hasLoad) {
            ...
            url = Constants.baseDataUrl + "/customer/personal/columns?cid=" + cid + "&limit=" + Constants.PAGE_SIZE + "&page=";
            //配置view属性
            configView();
            //开启loading,获取数据
            showDialog();
